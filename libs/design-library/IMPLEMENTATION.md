...
- [ ] 2.8 `Forms/Fieldset/` — `<fieldset>` + `<legend>`, group-level disabled
...
- [ ] 4.1 `Tooltip` — opens on **focus** as well as hover; never interactive content
...
| ---------------------------- | ----- | ---- |
| 0 — foundations              | 7     | 7    |
| 1 — independent primitives   | 14    | 13   |
